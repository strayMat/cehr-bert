...
/export/home/cse210038/.user_conda/miniconda/envs/cehr_bert/bin/python $cehr_bert_dir/spark_apps/prediction_cohorts/from_eds_stored_cohort.py -i $input_dir -o $output_dir -s $train_test_split_folder -sg "hospital_split"
