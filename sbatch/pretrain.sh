...
input_dir=$myDestPath/"cehr_bert_sequences"
myOutPut="cehr_bert_pretrained"
output_dir=$myDestPath/$myOutput
...
mkdir -p $mySourcePath/$myOutPut
(cd $output_dir; tar cf - .) | (cd $mySourcePath/$myOutPut; tar xpf -)