...
cd '/export/home/cse210037/Matthieu/cehr-bert/'


# This script launches a  binary classification problem by finetuning the model on the cehr_bert_finetunique_sequences_train.label column.
...
path2cohort=$mySourcePath

pretrained_model_name="bert_model-pretrained__trainsize_1.h5"

/export/home/cse210037/.user_conda/miniconda/envs/cehr-bert/bin/python evaluations/eds_mace_predict_proba.py -c $path2cohort -p $pretrained_model_name -r 4
