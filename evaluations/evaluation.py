...
def evaluate_sequence_models(args):
    ...
    if LSTM in args.model_evaluators:
        ...
        time_attention_tokenizer_path = os.path.join(
            args.time_attention_model_folder, p.tokenizer_path
        )
    ...
    if TEMPORAL_BERT_LSTM in args.model_evaluators:
        ...
        temporal_bert_tokenizer_path = os.path.join(
            args.temporal_bert_model_folder, p.tokenizer_path
        )
        temporal_bert_model_path = os.path.join(
            args.temporal_bert_model_folder,
    ...
    if RANDOM_VANILLA_BERT_LSTM in args.model_evaluators:
        ...
        visit_tokenizer_path = os.path.join(
            args.vanilla_bert_model_folder, p.visit_tokenizer_path
        )
